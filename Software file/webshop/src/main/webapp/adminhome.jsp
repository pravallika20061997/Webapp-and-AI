...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="javascipt:void(0)"><%=session.getAttribute("admin") %></a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<h2>Total Category : <%=Product.getTotalCategory() %></h2>
		<h2>Total Products : <%=Product.getTotalProducts() %></h2>
		<h2>Total Sales : <%=Product.getTotalSales() %></h2>
	</header>
