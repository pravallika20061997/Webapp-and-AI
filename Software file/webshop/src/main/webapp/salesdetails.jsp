...
<title>WebShop Sale Details</title>
<!-- Favicon-->
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="addcategory.jsp">Category</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded"
						href="javascipt:void(0)">Product</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
			...
			<div class="row justify-content-center">
					...
					<table class="table">
						...
						<tbody>
							...
							<%
							ResultSet rs = Product.getOrders("admin");
							while (rs.next()) {
							%>
							<tr>
								...
								<td><a class="btn btn-success" href="updateDelivery.jsp?id=<%=rs.getString(1) %>">Update Status</a>
							</tr>
							<%
							}
							%>
