...
<title>WebShop User Registration</title>
				...
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="credit"><i class="zmdi zmdi-gps-dot"></i></label>
								<input type="number" name="credit" id="credit"
									placeholder="Credit Card No" required="required" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="zipcode"><i class="zmdi zmdi-gps-dot"></i></label>
